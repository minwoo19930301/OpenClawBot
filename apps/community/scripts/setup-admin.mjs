...
// kept in memory only. The loopback-only form can reveal the bootstrap invitation
// to its owner; neither the invitation nor the password is written to logs.
